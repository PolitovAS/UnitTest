...
public class Calculator {
     ...
     */
    public double calculateDiscount(double sumBuy, double discountPercent){
        if (sumBuy < 0 || discountPercent < 0 || discountPercent > 100){
            throw new IllegalArgumentException("недопустимые аргументы");
        }
        return sumBuy - (sumBuy * (discountPercent/100));
    }
}